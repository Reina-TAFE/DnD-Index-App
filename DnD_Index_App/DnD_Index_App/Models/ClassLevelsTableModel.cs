...
namespace DnD_Index_App.Models
{
    public class ClassLevelsTableModel
    {
        ...
        {
            ResultsPageHeaderModel headerModel = new ResultsPageHeaderModel("Levels", null, null);
            ResultsPageSectionModel bodyModel = new ResultsPageSectionModel("Level Table", this.GetSections());
        ...
        {
            SectionItem table = this.ToSectionItem();
            List<SectionContent> sections= new List<SectionContent>();
            SectionContent tableSection = new SectionContent
            {
                SectionTitle = "Class Levels",
                ContentType = "LevelTable",
                Content = new List<SectionItem>{ {table}, }
            };
